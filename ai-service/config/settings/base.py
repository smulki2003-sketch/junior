...
SECRET_KEY = os.getenv("SECRET_KEY", "dev-only-ai-service-secret")
...
if DB_ENGINE == "django.db.backends.sqlite3":
    ...
    DATABASES = {
        "default": {
            "ENGINE": DB_ENGINE,
            "NAME": os.getenv("DB_NAME", "student_housing_ai_recommendation_db"),
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "apps.recommendation.auth.AuthServiceJWTAuthentication",
    ],
}
...
SEARCH_SERVICE_BASE_URL = os.getenv("SEARCH_SERVICE_BASE_URL", "http://localhost:8004")
NOTIFICATION_SERVICE_BASE_URL = os.getenv("NOTIFICATION_SERVICE_BASE_URL", "http://localhost:8007")
INTERNAL_SERVICE_TOKEN = os.getenv("INTERNAL_SERVICE_TOKEN", "")
AI_UPSTREAM_TIMEOUT_SECONDS = float(os.getenv("AI_UPSTREAM_TIMEOUT_SECONDS", "3.0"))
AI_NOTIFICATION_TIMEOUT_SECONDS = float(os.getenv("AI_NOTIFICATION_TIMEOUT_SECONDS", "1.5"))
