...
SECRET_KEY = os.getenv("SECRET_KEY", "dev-only-auth-service-secret")
...
if DB_ENGINE == "django.db.backends.sqlite3":
    ...
    DATABASES = {
        "default": {
            "ENGINE": DB_ENGINE,
            "NAME": os.getenv("DB_NAME", "student_housing_auth_db"),
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "apps.authentication.auth.JWTAccessAuthentication",
    ],
}
...
EXPOSE_PASSWORD_RESET_TOKEN = _get_bool(os.getenv("EXPOSE_PASSWORD_RESET_TOKEN"), DEBUG)
