...
SECRET_KEY = os.getenv("SECRET_KEY", "dev-only-moderation-service-secret")
...
if DB_ENGINE == "django.db.backends.sqlite3":
    ...
    DATABASES = {
        "default": {
            "ENGINE": DB_ENGINE,
            "NAME": os.getenv("DB_NAME", "student_housing_moderation_db"),
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "apps.moderation.auth.AuthServiceJWTAuthentication",
    ],
}
