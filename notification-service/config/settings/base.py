...
SECRET_KEY = os.getenv("SECRET_KEY", "dev-only-notification-service-secret")
...
if DB_ENGINE == "django.db.backends.sqlite3":
    ...
    DATABASES = {
        "default": {
            "ENGINE": DB_ENGINE,
            "NAME": os.getenv("DB_NAME", "student_housing_notification_db"),
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "apps.notifications.auth.AuthServiceJWTAuthentication",
    ],
}
