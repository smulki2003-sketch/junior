...
SECRET_KEY = os.getenv("SECRET_KEY", "dev-only-reporting-service-secret")
...
if DB_ENGINE == "django.db.backends.sqlite3":
    ...
    DATABASES = {
        "default": {
            "ENGINE": DB_ENGINE,
            "NAME": os.getenv("DB_NAME", "student_housing_reporting_db"),
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "apps.reports.auth.AuthServiceJWTAuthentication",
    ],
}
...
ADMIN_SERVICE_BASE_URL = os.getenv("ADMIN_SERVICE_BASE_URL", "http://localhost:8011")
...
AI_SERVICE_BASE_URL = os.getenv("AI_SERVICE_BASE_URL", "http://localhost:8008")
ROOMMATE_SERVICE_BASE_URL = os.getenv("ROOMMATE_SERVICE_BASE_URL", "http://localhost:8009")
MODERATION_SERVICE_BASE_URL = os.getenv("MODERATION_SERVICE_BASE_URL", "http://localhost:8010")

METRICS_SAMPLE_USER_IDS = os.getenv("METRICS_SAMPLE_USER_IDS", "")
METRICS_SAMPLE_PAYMENT_IDS = os.getenv("METRICS_SAMPLE_PAYMENT_IDS", "")
